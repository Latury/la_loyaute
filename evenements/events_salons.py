...
# ║
# ║ Gestion des événements liés aux salons Discord
...
# ═══════════════════════════════════════════════════════════════════════════════
# ║ 📦 CLASSE PRINCIPALE
# ║ Description : Cog pour gérer les événements de salons
# ═══════════════════════════════════════════════════════════════════════════════
...
class EventsSalons(commands.Cog):
    ...
    # ═══════════════════════════════════════════════════════════════════════════
    # ║ 🏗️ FONCTION 01 – Événement : Salon créé
    # ║ Description : Déclenché quand un salon est créé
    # ║ Listener : on_guild_channel_create
    # ═══════════════════════════════════════════════════════════════════════════
    ...
    # ═══════════════════════════════════════════════════════════════════════════
    # ║ 🗑️ FONCTION 02 – Événement : Salon supprimé
    # ║ Description : Déclenché quand un salon est supprimé
    # ║ Listener : on_guild_channel_delete
    # ═══════════════════════════════════════════════════════════════════════════

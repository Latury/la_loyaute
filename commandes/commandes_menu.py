...
# ║ 🎨 Vue du menu principal avec boutons de navigation vers sections
# ═══════════════════════════════════════════════════════════════════════════════
...
class MenuPrincipalView(discord.ui.View):
    ...
    # ╔═════════════════════════════════════════════════════════════════════════
    # ║ 📊 BOUTON 01 – Logs
    # ║ 📊 Affiche le menu de configuration des logs du serveur
    # ╚═════════════════════════════════════════════════════════════════════════
    ...
    # ╔═════════════════════════════════════════════════════════════════════════
    # ║ 👋 BOUTON 02 – Bienvenue
    # ║ 👋 Affiche le menu de configuration des messages d'arrivée/départ
    # ╚═════════════════════════════════════════════════════════════════════════
    ...
    # ╔═════════════════════════════════════════════════════════════════════════
    # ║ 🛡️ BOUTON 03 – Modération
    # ║ 🛡️ Affiche le menu de configuration de la modération du serveur
    # ╚═════════════════════════════════════════════════════════════════════════
    ...
    # ╔═════════════════════════════════════════════════════════════════════════
    # ║ 🎭 BOUTON 04 – Auto-rôles
    # ║ 🎭 Affiche le menu de configuration de l'attribution automatique de rôles
    # ╚═════════════════════════════════════════════════════════════════════════
    ...
    # ╔═════════════════════════════════════════════════════════════════════════
    # ║ ℹ️ BOUTON 05 – Informations
    # ║ ℹ️ Affiche les informations détaillées sur le bot
    # ╚═════════════════════════════════════════════════════════════════════════
...
# ═══════════════════════════════════════════════════════════════════════════════
# ║ 📋 CLASSE : CommandesMenu
# ║ 📋 Gestion complète du menu de configuration interactif
# ═══════════════════════════════════════════════════════════════════════════════
...
class CommandesMenu(commands.Cog):
    ...
    def __init__(self, bot):
        ...
        self.logger.info("✅ Cog CommandesMenu chargé")
...
# ═══════════════════════════════════════════════════════════════════════════════
# ║ 🔌 FONCTION SETUP
# ║ 🔌 Charge le cog des commandes de menu dans le bot
# ═══════════════════════════════════════════════════════════════════════════════

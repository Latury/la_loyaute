...
### **v0.3.0 - Interface Configuration Interactive** *(Priorité #1)*
...
### **v0.4.0 - Système d'Économie** *(Priorité #2)*
...
1. **v0.3.0** - Interface config interactive *(Priorité ABSOLUE)*

...
# ║ Outils Dev | Script avancé pour détecter les erreurs de type Pylance/Pyright
...
# ╔═══════════════════════════════════════════════════════════════════════════════
# ║
# ║ 🔍 FICHIER : analyser_erreurs.py
# ║ 📦 MODULE : outils_dev
# ║ 📝 DESCRIPTION : Script avancé pour détecter les erreurs de type Pylance/Pyright
# ║ 👤 AUTEUR : Latury
...
# ╔═══════════════════════════════════════════════════════════════════════════════
# ║ ⚙️ CONFIGURATION
# ║ 📝 Chemins et configurations générales
# ╚═══════════════════════════════════════════════════════════════════════════════
...
# ║ 📝 Fonctions de support et d'analyse
# ╚═══════════════════════════════════════════════════════════════════════════════

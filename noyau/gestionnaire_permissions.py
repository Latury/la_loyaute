...
# ║
# ║  Système de vérification des permissions et des rôles
...
# ╔══════════════════════════════════════════════════════════════════════════════
# ║ 🔐 Fonction 01 – Vérification développeur
...
# ╔══════════════════════════════════════════════════════════════════════════════
# ║ 👑 Fonction 02 – Vérification administrateur
...
# ╔══════════════════════════════════════════════════════════════════════════════
# ║ 🛡️ Fonction 03 – Vérification modérateur
# ║ Description : Vérifie si l'utilisateur est modérateur
# ╚══════════════════════════════════════════════════════════════════════════════
...
# ╔══════════════════════════════════════════════════════════════════════════════
# ║ 🎯 Fonction 04 – Vérification propriétaire du serveur
# ║ Description : Vérifie si l'utilisateur est le propriétaire du serveur
# ╚══════════════════════════════════════════════════════════════════════════════
...
# ╔══════════════════════════════════════════════════════════════════════════════
# ║ ✅ Fonction 05 – Vérification permissions complètes
# ║ Description : Vérifie tous les niveaux de permissions
# ╚══════════════════════════════════════════════════════════════════════════════
...
# ╔══════════════════════════════════════════════════════════════════════════════
# ║ 🎭 Classe 01 – Décorateur pour les checks
# ║ Description : Décorateurs personnalisés pour les commandes
# ╚══════════════════════════════════════════════════════════════════════════════
...
# ╔══════════════════════════════════════════════════════════════════════════════
# ║ 📊 Fonction 06 – Obtenir le niveau d'autorisation
# ║ Description : Retourne le niveau de permission d'un utilisateur
# ╚══════════════════════════════════════════════════════════════════════════════
